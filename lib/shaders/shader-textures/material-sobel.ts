namespace Trike {
	...
	*/
    export class MaterialSobel extends MaterialMulti {
		/**
		...
		*/
        constructor( width: number, height: number ) {
            ...
            this.materials[ PassType.Texture ] = new PassMaterial( 'Sobel', this );
            ...
            this.addUniform( new UniformVar( 'frequency', Trike.UniformType.FLOAT, 4 ), true );
            this.addUniform( new UniformVar( 'period', Trike.UniformType.FLOAT, 1 ), true );
            this.addUniform( new UniformVar( 'amplitude', Trike.UniformType.FLOAT, 0.1 ), true );
        ...
        * @returns {number}
        */
        get amplitude(): number { return this.materials[ PassType.Texture ]._uniforms[ 'amplitude' ].value; }
        ...
        */
        set amplitude( val: number ) {
            this.materials[ PassType.Texture ].setUniform( 'amplitude', val );
        }
        ...
        */
        set frequency( val: number ) {
            this.materials[ PassType.Texture ].setUniform( 'frequency', val );
        }
        ...
        */
        set period( val: number ) {
            this.materials[ PassType.Texture ].setUniform( 'period', val );
        }
    }
}
