namespace Trike {
    export class ImprovedNoise {
        private static _p: Array<number>;
        ...
        getNoise( x: number, y: number, z: number ): number {
            const p: Array<number> = ImprovedNoise._p;

            const floorX: number = ~~x, floorY: number = ~~y, floorZ: number = ~~z;

            const X: number = floorX & 255, Y: number = floorY & 255, Z: number = floorZ & 255;
            ...
            return this.lerp( w, this.lerp( v, this.lerp( u, this.grad( p[ AA ], x, y, z ),
                ...
                this.lerp( v, this.lerp( u, this.grad( p[ AA + 1 ], x, y, zMinus1 ),
