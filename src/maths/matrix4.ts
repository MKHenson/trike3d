...
export class Matrix4 {
  ...
  makeRotationFromQuaternion(q: Quaternion) {
    var zero = Matrix4.buffer1.set(0, 0, 0);
    var one = Matrix4.buffer2.set(1, 1, 1);
  ...
  lookAt(eye: Vector3, target: Vector3, up: Vector3) {
    var x = Matrix4.buffer1;
    var y = Matrix4.buffer2;
    var z = Matrix4.buffer3;
  ...
  decompose(position: Vector3, quaternion: Quaternion, scale: Vector3) {
    var vector = Matrix4.buffer1;
    var matrix = Matrix4.buffer4;
