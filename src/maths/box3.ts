...
export class Box3 {
  ...
  static buffer7 = new Vector3();
  static buffer8 = new Vector3();
  static buffer9 = new Vector3();
  static buffer10 = new Vector3();
  ...
  intersectsTriangle(triangle: Triangle) {
    ...
    var testAxis = Box3.buffer7;

    var center = Box3.buffer8;
    var extents = Box3.buffer9;

    var triangleNormal = Box3.buffer10;
